...
export default function Front(){
    return(
        ...
        <div className="contain" id="home">
            <div className="content">
                ...
                <ul>
                    <li>
                        ...
                        <a href="mailto:yusufmubarak460@gmail.com">Yusufmubarak460@gmail.com</a>
                    </li>
                    <li>
                        ...
                        <a href="tel:+2348120460649">+2348120460649</a>
                    </li>
                    <li>
            ...
            <img src="src/assets/me.jpg" alt="Pic of a man sitting down." />
        </div>
        </>
    )
}